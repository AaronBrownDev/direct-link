...
type JoinReply struct {
	...
	LivekitUrl    string                 `protobuf:"bytes,2,opt,name=livekit_url,json=livekitUrl,proto3" json:"livekit_url,omitempty"` // LiveKit server URL (directors for media; cameras for data channel)
	...
	DataToken     string                 `protobuf:"bytes,5,opt,name=data_token,json=dataToken,proto3" json:"data_token,omitempty"`    // LiveKit data-only JWT for camera latency measurement (cameras only)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *JoinReply) GetDataToken() string {
	if x != nil {
		return x.DataToken
	}
	return ""
...
const file_signaling_proto_rawDesc = "" +
	...
	"\n" +
	"stream_key\x18\x04 \x01(\tR\tstreamKey\x12\x1d\n" +
	"\n" +
	"data_token\x18\x05 \x01(\tR\tdataToken\"P\n" +
